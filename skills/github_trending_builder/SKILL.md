...
The orchestrator (`scripts/run-ai-briefing.sh`) rebuilds `web/manifest.json` from disk as a post-step via `scripts/rebuild_manifest.py`. This skill writes its data files and exits.
